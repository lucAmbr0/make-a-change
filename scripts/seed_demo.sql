...
INSERT INTO `campaigns` (organization_id, creator_id, title, description, created_at, cover_path, signature_goal, is_public, comments_active, comments_require_approval, is_archived) VALUES (1, 1, 'Pulizia Parco Centro Città', 'Campagna per la pulizia completa e il ripristino del parco centrale della città. Vogliamo raccogliere firme per organizzare una giornata ecologica con volontari della comunità e professionisti del settore. Il progetto include la rimozione di rifiuti accumulati, la potatura degli alberi secondo standard di cura forestale, il ripristino delle aree gioco per i bambini con attrezzature sicure e conformi alle normative europee, e il miglioramento della segnaletica. Sarà un''occasione straordinaria per unire la comunità attorno a un obiettivo comune e creare un legame più profondo con lo spazio pubblico che condividiamo.', '2026-03-06 08:00:00', NULL, 10, 1, 1, 0, 0);
INSERT INTO `campaigns` (organization_id, creator_id, title, description, created_at, cover_path, signature_goal, is_public, comments_active, comments_require_approval, is_archived) VALUES (1, 1, 'Illuminazione Notturna Sentieri Parco', 'Progetto per l''installazione di illuminazione LED eco-sostenibile nei sentieri del parco per garantire maggiore sicurezza ai visitatori durante le ore serali e notturne. La tecnologia LED proposta ridurrà i consumi energetici del 60% rispetto ai sistemi tradizionali ad alogenuri metallici e permetterà una regolazione intelligente dell''intensità luminosa. Vogliamo raccogliere il supporto della comunità per presentare il progetto al comune e ai finanziatori regionali. Questo intervento aumenterà la fruibilità del parco in orari serali e avrà un impatto positivo sulla sicurezza percepita dei cittadini.', '2026-03-07 09:30:00', NULL, 8, 1, 1, 1, 0);
INSERT INTO `campaigns` (organization_id, creator_id, title, description, created_at, cover_path, signature_goal, is_public, comments_active, comments_require_approval, is_archived) VALUES (2, 2, 'Attraversamenti Pedonali Scuole Primarie', 'Iniziativa per aumentare la sicurezza dei bambini con l''installazione di attraversamenti pedonali segnalati, illuminati e con semafori intelligenti presso le tre scuole primarie del quartiere. Abbiamo già effettuato studi approfonditi sulla viabilità e identificato i punti critici dove si concentrano gli incidenti. Chiediamo il supporto dei residenti, dei genitori e delle istituzioni scolastiche per questo importante progetto di sicurezza stradale. I dati dimostrano che attraversamenti ben realizzati riducono gli incidenti del 70% nelle zone scolastiche.', '2026-03-08 10:15:00', NULL, 12, 1, 1, 0, 0);
INSERT INTO `campaigns` (organization_id, creator_id, title, description, created_at, cover_path, signature_goal, is_public, comments_active, comments_require_approval, is_archived) VALUES (2, 2, 'Riduzione Velocità Limiti Residenziali', 'Campagna riservata ai membri dell''organizzazione per discutere la proposta di riduzione dei limiti di velocità nelle zone residenziali da 50 a 30 km/h. Questa misura comporterebbe una riduzione stimata del 40% degli incidenti stradali secondo i dati internazionali e migliorerebbe significativamente la qualità della vita nei nostri quartieri. Solo i membri potranno sottoscrivere questa petizione e partecipare ai workshop di approfondimento. La riduzione di velocità avrà anche effetti positivi sulla qualità dell''aria e sulla riduzione dell''inquinamento acustico.', '2026-03-09 11:45:00', NULL, 15, 0, 1, 0, 0);
INSERT INTO `campaigns` (organization_id, creator_id, title, description, created_at, cover_path, signature_goal, is_public, comments_active, comments_require_approval, is_archived) VALUES (3, 3, 'Convegno Culturale Primavera 2026', 'Convegno esclusivo su temi di letteratura contemporanea e arti visive con focus su autori europei e movimenti artistici emergenti. Riservato ai soli membri del circolo per mantenere l''qualità del dibattito e l''intimità delle discussioni. Ospiteremo tre speaker internazionali di rilievo e quattro mostre d''arte locale curate da critici professionisti. L''evento si terrà per tre giorni consecutivi con workshop pomeridiani specializzati, cene di gala serali e sessioni di networking tra i partecipanti. Questo evento rappresenta il culmine della stagione culturale del nostro circolo.', '2026-03-10 13:00:00', NULL, 5, 0, 1, 0, 0);

-- CAMPAIGNS WITHOUT ORGANIZATION (5 campaigns)
INSERT INTO `campaigns` (organization_id, creator_id, title, description, created_at, cover_path, signature_goal, is_public, comments_active, comments_require_approval, is_archived) VALUES (NULL, 1, 'Supporto Biblioteca Comunale Ampliamento', 'Campagna pubblica per raccogliere firme a supporto del progetto di ampliamento della biblioteca comunale. La biblioteca attualmente può ospitare solo 50 persone contemporaneamente, mentre la comunità che la utiliza è cresciuta a 200 persone mensili, evidenziando una chiara necessità di espansione. L''espansione prevista aggiungerà una sezione ragazzi con oltre 5000 libri per diverse fasce di età, una sala lettura tranquilla dedicata a ricerca e studio, nuovi computer per l''accesso pubblico a internet e laboratori per corsi di informatica e alfabetizzazione digitale. Questo investimento supporterà l''inclusione digitale e rafforzerà il ruolo della biblioteca come centro culturale della comunità.', '2026-03-11 14:20:00', NULL, 20, 1, 1, 0, 0);
INSERT INTO `campaigns` (organization_id, creator_id, title, description, created_at, cover_path, signature_goal, is_public, comments_active, comments_require_approval, is_archived) VALUES (NULL, 3, 'Istituzione Riserva Naturale Locale', 'Campagna privata per raccogliere firme sulla proposta di istituire una riserva naturale protetta nell''area collinare della periferia, un ecosistema di grande valore biologico e scientifico. Solo i firmatari autorizzati e gli esperti potranno visualizzare questa campagna sensibile. L''area è attualmente minacciata da sviluppo immobiliare speculativo e vogliamo preservarla come zona protetta per la biodiversità locale e la ricerca scientifica. Studi biologici hanno identificato 50 specie a rischio di estinzione che nidificano o vivono in questa area. La riserva potrebbe diventare un centro di ricerca e educazione ambientale.', '2026-03-12 15:30:00', NULL, 25, 0, 1, 0, 0);
INSERT INTO `campaigns` (organization_id, creator_id, title, description, created_at, cover_path, signature_goal, is_public, comments_active, comments_require_approval, is_archived) VALUES (NULL, 4, 'Piantumazione Alberi Viale Principale', 'Campagna per l''aggiunta di 100 alberi autoctoni nel viale principale della città come parte del progetto di aumento del verde urbano e della mitigazione dei cambiamenti climatici. Ogni albero contribuirà a ridurre il calore urbano di circa 2 gradi in un raggio di 10 metri grazie all''ombreggiatura naturale e all''evapotraspirazione. Vogliamo raccogliere il supporto popolare per questa iniziativa di sostenibilità ambientale che avrà benefici nella qualità dell''aria, nella salute mentale dei cittadini e nella biodiversità urbana. Gli alberi saranno monitorati scientificamente per documentare i benefici ambientali.', '2026-03-13 16:45:00', NULL, 18, 1, 0, 0, 0);
INSERT INTO `campaigns` (organization_id, creator_id, title, description, created_at, cover_path, signature_goal, is_public, comments_active, comments_require_approval, is_archived) VALUES (NULL, 5, 'Raccolta Fondi Progetto Educativo Speciale', 'Campagna riservata per raccogliere adesioni e supporto finanziario al progetto educativo speciale destinato a bambini con esigenze educative specifiche e difficoltà di apprendimento. La campagna è limitata ai genitori, educatori e professionisti della rete locale per garantire discrezione e comprensione del contesto. Il progetto prevede corsi specializzati con insegnanti certificati, materiali didattici personalizzati adattati ai diversi stili di apprendimento, e consulenza psicopedagogica continuativa per sei mesi. Il supporto finanziario permetterà a famiglie con risorse limitate di accedere a questi servizi.', '2026-03-14 17:15:00', NULL, 8, 0, 1, 0, 0);
INSERT INTO `campaigns` (organization_id, creator_id, title, description, created_at, cover_path, signature_goal, is_public, comments_active, comments_require_approval, is_archived) VALUES (NULL, 6, 'Percorso Ciclopedonale Centro-Stazione', 'Progetto per la creazione di un percorso ciclopedonale sicuro e ben illuminato che colleghi il centro città con la stazione ferroviaria principale, eliminando l''attuale situazione di pericolo e disagio. Il percorso di 3 km sarà parzialmente sotterraneo dove il traffico automobilistico è elevato per garantire massima sicurezza, e completamente aereo nelle zone residenziali per mantenere l''contatto con il territorio. Questo progetto potrebbe ridurre l''utilizzo di auto private del 15% nel nostro comune e aumentare significativamente l''utilizzo del trasporto pubblico ferroviario. Lo studio preliminare indica benefici enormi per la congestione stradale e la qualità dell''aria.', '2026-03-15 18:00:00', NULL, 22, 1, 1, 0, 0);
